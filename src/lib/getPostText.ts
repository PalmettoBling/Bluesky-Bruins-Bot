...
export default async function getPostText() {
	...
	var awaitTweet = await mastodon.getStatuses("111988852653317664", {'limit':limitVal}); //Use the Mastodon API to get a specified number of recent posts from the Mastodon API.
